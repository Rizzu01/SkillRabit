...
.video-section {
    padding: 50px 20px;
    text-align: center;
    background-image: url("assets/images/videos_bg.svg");
...
<div class="main-wrapper">
    ...
    <header class="edu-header header-sticky header-transparent header-style-2 header-default">
        <div class="row align-items-center">
            <div class="col-lg-4 col-xl-3 col-md-6 col-6">
                ...
                <div class="logo">
                    <a href="landing">
                        <img class="logo-light" id="logo-wid" src="assets/images/logo.svg" alt="logo-skill-rabbit">
                    </a>
                </div>
            </div>
                ...
                <div class="header-right d-flex justify-content-end">
                    <div class="header-quote">
                        <div class="quote-icon quote-user" >
                            <button type="button" class="btn btn-primary book-free" data-bs-toggle="modal" data-bs-target="#strategyModal">Book FREE Call <img src="assets/images/free_arrow.svg" alt="free-arrow" class="free-call"></button>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            <p class="standard"><span class="industry"><img src="assets/images/computer.svg" class="computer"> Industry Standard</span>  CERTIFIED PROGRAM</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="banner-image" id="stu-bg">
                            <div class="banner-main-image">
                                <img class="img-01" data-sal-delay="150" data-sal="fade" data-sal-duration="800" src="assets/images/stu_bg.svg" alt="stu_bg" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4 text-center">
                ...
                <div class="col-md-4 col-sm-4 col-4">
                    <div class="feature-card gradient-purple">
                        <img src="assets/images/graduation.svg" alt="Graduation" class="feature-icon" />
                ...
                <div class="col-md-4 col-sm-4 col-4">
                    <div class="feature-card gradient-blue">
                        <img src="assets/images/time.svg" alt="time" class="feature-icon" />
                ...
                <div class="col-md-4 col-sm-4 col-4">
                    <div class="feature-card gradient-purple">
                        <img src="assets/images/task-management.svg" alt="task-management" class="feature-icon" />
    ...
    <section class="video-section">
        <div class="video-container">
            ...
            <div class="play-btn" id="playBtn"><img src="assets/images/video-icon.svg" alt="video-icon"> </div>
        </div>
        <button type="button" class="btn custom-btn" data-bs-toggle="modal" data-bs-target="#strategyModal"><img src="assets/images/call.svg" width="20"> Schedule A Call</button>
        <p class="video-text">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/checklist.svg" alt="checklist-cion">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/ai.svg" alt="ai-icon">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/managements.svg" alt="managements-icon">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/team.svg" alt="team-icon">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/increase.svg" alt="increase-icon">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="400" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/india.svg" alt="india-icon">
                            </div>
                            <div class="content">
    ...
    <div class="container py-5" id="foundation">
        <h2 class="section-title">
            What You'll Learn <span> <img src="assets/images/books.svg" class="book-icon" alt="book"> </span>
        </h2>
        <div class="accordion" id="curriculumAccordion">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        <span class="icon"> <img src="assets/images/layers.svg" alt="layers-icon"> </span> Phase 1: Foundation (Month 1) <br>4 - Topic
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        <span class="icon"><img src="assets/images/front-end.svg" alt="front-end-icon"></span> Phase 2: Front-End Development (Months 2–3) <br>4 - Topic
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        <span class="icon"><img src="assets/images/coding.svg" alt="coding-icon"></span> Phase 3: Back-End Development (Months 4–5) <br>4 - Topic
                    </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                        <span class="icon"><img src="assets/images/skill.svg" alt="skill-icon"></span> Phase 4: Advanced Topics (Month 6) <br>4 - Topic
                    </button>
                </h2>
            ...
            <div class="row">
                    ...
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon" style="margin-bottom: 20px;">
                                <img src="assets/images/job-interview.svg" alt="job-interview-icon">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 mb-4" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/teacher.svg" alt="teacher-icon">
                            </div>
                            <div class="content">
            ...
            <div class="row">
                <div class="col-lg-4 offset-lg-2 col-md-6 col-sm-12 mb-4" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/portfolio.svg" alt="portfolio-icon">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 mb-4" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card">
                        <div class="inner">
                            <div class="icon">
                                <img src="assets/images/job-description.svg" alt="job-description-icon">
                            </div>
                            <div class="content">
